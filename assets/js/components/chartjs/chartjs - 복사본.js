...
let mainDatasets = []; //메인 차트에 대한 스타일 설정
...
function getmainChartData(obj) {
    ...
    if (maChart != undefined) {
        ...
        maChart.data.datasets[0].label = "전체 매출 실적1";
        maChart.data.datasets[0].data = dataArr;
        maChart.data.datasets[1].label = "전체 매출 실적2";
    ...
    if (mmChart != undefined) {
        ...
        mmChart.data.datasets[0].label = "일일 사용자1";
        mmChart.data.datasets[0].data = dataArr;
        mmChart.data.datasets[1].label = "일일 사용자2";
    ...
    if (mpChart != undefined) {
        ...
        mpChart.data.datasets[0].label = "공유 주차장 매출1";
        mpChart.data.datasets[0].data = dataArr;
        mpChart.data.datasets[1].label = "공유 주차장 매출2";
    ...
    if (mgChart != undefined) {
        ...
        mgChart.data.datasets[0].label = "차고지 임대 매출1";
        mgChart.data.datasets[0].data = dataArr;
        mgChart.data.datasets[1].label = "차고지 임대 매출2";
